...
**`\roman`** — Numbers from 1 to 4999 inclusive converted to roman numeral strings. Example: i, ii, iii, ...
...
See the [List Structures](/docs/4.common-elements/6.list-structures) chapter.
