...
There are ways to get around the default behavior, however; see [\\paragraph line break](/document-fundamentals/paragraph-formatting#.5Cparagraph_line_break) for more information.
...
See [Fonts](/document-fundamentals/fonts#Font_encoding) for an explanation.
...
Most likely you have used `\raggedleft`, `\raggedright` or `\centering` at some point and forgotten to switch it off. These commands are switches — they remain active until the end of the scope, or until the end of the document if there is no scope. See [Paragraph Alignment](/document-fundamentals/paragraph-formatting#Paragraph_Alignment) for more information.
