...
See [Boxes](/docs/5.latex-mechanics/4.boxes).
...
When using these commands, you may duplicate the text that you want to use as reference if you plan to also display it. But LaTeX also provides `\savebox` to avoid this duplication. You may wish to look at the example below to see how you can use these. See [Boxes](/docs/5.latex-mechanics/4.boxes) for more details.
