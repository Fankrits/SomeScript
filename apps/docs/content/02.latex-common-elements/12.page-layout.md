...
We will often have to deal with TeX lengths in this chapter. You should have a look at [Lengths](/lengths) for comprehensive details on the topic.
...
For books (and in general documents using the `twoside` option), the `landscape`-environment unfortunately does not pay attention to the different layout of even and odd pages. The macro can be fixed using a few lines of extra code in the preamble<ref>https://stackoverflow.com/questions/4982219/how-to-make-landscape-mode-rotate-properly-in-a-twoside-book/5320962#5320962</ref>.
