...
Nevertheless, in that case, the current footnote counter is still incremented, so for instance you'd get footnote 1, unnumbered, and 3.  A better solution<ref name="csli footnotes">[LaTeX footnotes](https://web.archive.org/web/20131716502800/http://help-csli.stanford.edu/tex/latex-footnotes.shtml)</ref> consists in defining the following macro in the preamble, and to use it:
