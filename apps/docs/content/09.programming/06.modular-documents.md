...
This is actually the beginning of the process of writing a package. See [LaTeX/Macros](/programming/macros) for more details.

For a list of several packages you can use, see the [List of Packages](/appendices/package-reference) section.
