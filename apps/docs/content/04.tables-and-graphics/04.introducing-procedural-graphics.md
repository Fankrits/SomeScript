...
There are several packages supporting the creation of graphics directly in LaTeX, including [`picture`](/docs/9.latex-creating-graphics/3.picture), [`xy-Pic`](/docs/9.latex-creating-graphics/6.xy-pic) and [`PGF/TikZ`](/docs/9.latex-creating-graphics/4.pgf-tikz), described in the following sections.
