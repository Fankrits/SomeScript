...
It will be typeset with line breaks separating it from the rest of the text.
...
where *numberby* is the name of the [section level](/document-fundamentals/document-structure#sectioning-commands) (section/subsection/etc.) at which the numbering is to take place.
...
## External links
* [`amsthm v2.20.3` documentation](http://mirrors.rit.edu/CTAN/macros/latex/required/amscls/doc/amsthdoc.pdf)
