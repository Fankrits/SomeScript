...
export const GROUPS: ToolGroup[] = [
  {
    ...
    menu: [
      ...
      { label: "Emphasis", text: "\\emph{}", cursorOffset: -1 },
      { icon: Code, label: "Typewriter", text: "\\texttt{}", cursorOffset: -1 },
      { label: "Small caps", text: "\\textsc{}", cursorOffset: -1 },
    ],
  },
  {
    id: "structure",
    ...
    menu: [
      ...
      { label: "Subsubsection", text: "\\subsubsection{}", cursorOffset: -1 },
      { label: "Paragraph", text: "\\paragraph{}", cursorOffset: -1 },
      { icon: BookOpen, label: "Part", text: "\\part{}", cursorOffset: -1 },
      { label: "Chapter", text: "\\chapter{}", cursorOffset: -1 },
    ],
  },
  {
    id: "math",
    ...
    menuTriggerIcon: Pi,
    menu: [
      { label: "Display math", text: "\\[\n  \n\\]", cursorOffset: -3, shortcut: "⌘⇧M" },
      { label: "Equation", text: "\\begin{equation}\n  \n\\end{equation}", cursorOffset: -15 },
      { label: "Align", text: "\\begin{align}\n  \n\\end{align}", cursorOffset: -12 },
      { label: "Fraction", text: "\\frac{}{}", cursorOffset: -3 },
      { label: "Square root", text: "\\sqrt{}", cursorOffset: -1 },
      { label: "Subscript", text: "_{}", cursorOffset: -1 },
      { label: "Superscript", text: "^{}", cursorOffset: -1 },
      { label: "Sum", text: "\\sum_{i=1}^{n}", cursorOffset: 0 },
      { label: "Integral", text: "\\int_{a}^{b}", cursorOffset: 0 },
      { label: "Limit", text: "\\lim_{x \\to \\infty}", cursorOffset: 0 },
    ],
  },
  {
    id: "lists",
  ...
  },
  {
    ...
    menu: [
      ...
      { label: "Image", text: "\\includegraphics[width=\\textwidth]{}", cursorOffset: -1 },
      {
        icon: Table,
        label: "Table",
      ...
      { label: "Footnote", text: "\\footnote{}", cursorOffset: -1 },
  ...
  },
  {
    ...
    menu: [
      ...
      { label: "Equation reference", text: "\\eqref{}", cursorOffset: -1 },
      { label: "Page reference", text: "\\pageref{}", cursorOffset: -1 },
