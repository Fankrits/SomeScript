...
const AttachmentRemove: FC = () => {
  return (
    <AttachmentPrimitive.Remove asChild>
      <TooltipIconButton
        tooltip="Remove file"
        // Sits on top of an image thumbnail, so it needs its own surface —
        // but a translucent background token keeps it legible in both themes
        // instead of the hardcoded white-on-black it used to be.
        className="aui-attachment-tile-remove text-foreground hover:[&_svg]:text-destructive bg-background/90 hover:bg-background! absolute end-1.5 top-1.5 size-3.5 rounded-full border opacity-100 shadow-sm backdrop-blur-sm"
        side="top"
      >
