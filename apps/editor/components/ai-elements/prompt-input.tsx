...
export const PromptInputProvider = ({
  ...
  // oxlint-disable-next-line no-underscore-dangle -- deliberate double-underscore marks this internal-only on PromptInputControllerProps (see its doc comment).
...
export const PromptInput = ({
  ...
  useEffect(() => {
    ...
    // oxlint-disable-next-line no-underscore-dangle -- internal-only API, see its doc comment.
