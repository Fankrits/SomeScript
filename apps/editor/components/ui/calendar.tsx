...
function Calendar({
  ...
  // Stable across renders unless locale changes, so DayPicker doesn't see a new
  // DayButton component identity (and remount it, dropping focus) on every render.
  const dayButtonWithLocale = React.useCallback<CustomComponents["DayButton"]>(
    (dayButtonProps) => <CalendarDayButton locale={locale} {...dayButtonProps} />,
    [locale],
  );
