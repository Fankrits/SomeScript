      ...
      <div className="hidden lg:flex lg:w-1/2 bg-secondary/30 relative items-center justify-center p-12 overflow-hidden border-r border-border">
        ...
        <div className="relative z-10 max-w-md flex flex-col gap-6 text-left">
          ...
          <p className="text-muted-foreground font-light leading-relaxed">
            Log in to access your dashboard, manage your LaTeX projects, compile in real-time, and
            draft academic papers with your AI writing assistant.
          </p>
        </div>
      </div>
          ...
          <div className="flex justify-center">
            <SignIn
              appearance={{
                elements: {
                  rootBox:
                    "w-full shadow-lg border border-border rounded-xl overflow-hidden bg-card",
                  ...
                  formButtonPrimary:
                    "bg-primary hover:bg-primary/90 text-primary-foreground font-semibold rounded-lg text-sm shadow-md transition-colors py-2.5",
                  formFieldInput:
                    "border border-border bg-card text-foreground rounded-lg py-2 px-3 text-sm focus:border-primary/40 focus:ring-1 focus:ring-primary/40 focus:outline-none transition-all",
                  footerActionLink:
