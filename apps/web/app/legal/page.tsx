  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground font-sans selection:bg-primary/20 relative overflow-hidden">
      ...
      <main className="flex-1 flex flex-col relative w-full z-10 py-12 px-6 max-w-4xl mx-auto">
          ...
          {(["privacy", "terms", "security"] as LegalTab[]).map((tab) => (
            <button
              ...
              className={cn(
                ...
                activeTab === tab
                  ? "bg-[#dd7e21] text-white border-[#dd7e21] shadow-lg shadow-[#dd7e21]/15"
        ...
        <LiquidGlassCard
          glassSize="default"
          className="border-white/10 bg-[#0e161b]/40 backdrop-blur-md rounded-xl p-8 text-white space-y-6"
        >
          {activeTab === "privacy" && (
            <div className="space-y-6">
              <h2 className="text-2xl font-medium font-serif text-[#dd7e21] border-b border-white/10 pb-3">
                Privacy Policy
              </h2>
              <p className="text-xs text-white/40">Last Updated: July 11, 2026</p>
              
              <div className="space-y-4 text-white/80 font-light text-sm leading-relaxed">
                <p>
                ...
                <h3 className="text-base font-serif font-semibold text-white mt-4">1. Information We Collect</h3>
                <p>
                ...
                <h3 className="text-base font-serif font-semibold text-white mt-4">2. How We Use Document Content</h3>
                <p>
                ...
                <h3 className="text-base font-serif font-semibold text-white mt-4">3. Data Sharing & Security</h3>
                <p>
          ...
          {activeTab === "terms" && (
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-white/80 font-light text-sm leading-relaxed">
                ...
                <h3 className="text-base font-serif font-semibold text-white mt-4">1. Use of Service</h3>
                <p>
                ...
                <h3 className="text-base font-serif font-semibold text-white mt-4">2. Intellectual Property Rights</h3>
                <p>
                ...
                <h3 className="text-base font-serif font-semibold text-white mt-4">3. Limitation of Liability</h3>
                <p>
          ...
          {activeTab === "security" && (
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-white/80 font-light text-sm leading-relaxed">
                ...
                <h3 className="text-base font-serif font-semibold text-white mt-4">1. Isolated Compilation Sandboxes</h3>
                <p>
                ...
                <h3 className="text-base font-serif font-semibold text-white mt-4">2. Encryption</h3>
                <p>
                ...
                <h3 className="text-base font-serif font-semibold text-white mt-4">3. Reporting Vulnerabilities</h3>
                <p>
                  If you discover a security vulnerability in our platform or compiler, please report it immediately to our security handlers at <a href="mailto:contact@fankrits.com" className="text-[#dd7e21] hover:underline font-medium">contact@fankrits.com</a>.
                </p>
              </div>
            </div>
          )}
