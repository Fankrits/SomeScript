  ...
  const data = [
    {
      ...
      content: (
        <div className="max-w-2xl">
          ...
          <LiquidGlassCard className="border-border bg-background p-4 font-mono text-xs text-foreground">
            <div className="flex items-center gap-1.5 border-b border-border pb-2 mb-3 text-foreground/40">
              <Terminal className="h-3.5 w-3.5" />
              <span>input_prompt.tex</span>
            </div>
            <div className="space-y-1 text-foreground/80">
              <p className="text-foreground/40">{"// Prompt: Write a matrix equation representing a 2D rotation"}</p>
              <p><span className="text-[#5b52c9]">\begin</span>&#123;equation&#125;</p>
              <p className="pl-4 text-[#1f9563]">R = \begin&#123;pmatrix&#125; \cos\theta & -\sin\theta \\ \sin\theta & \cos\theta \end&#123;pmatrix&#125;</p>
              <p><span className="text-[#5b52c9]">\end</span>&#123;equation&#125;</p>
            </div>
          </LiquidGlassCard>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="max-w-2xl">
          ...
          <LiquidGlassCard className="border-border bg-background p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2">
                <p className="text-xs font-semibold text-foreground">Eve AI Assistant</p>
                <p className="text-xs text-foreground/70 leading-relaxed bg-foreground/5 border border-border p-3 rounded-lg">
                ...
                <div className="flex gap-2">
                  <span className="text-[10px] bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 px-2 py-0.5 rounded flex items-center gap-1">
                    <CheckCircle2 className="h-3 w-3" /> TikZ Code Generated
                  </span>
                  <span className="text-[10px] bg-blue-500/10 border border-blue-500/20 text-blue-600 px-2 py-0.5 rounded flex items-center gap-1">
      ...
      content: (
        <div className="max-w-2xl">
          ...
          <div className="grid grid-cols-2 gap-4">
            <LiquidGlassCard className="border-border bg-background p-4 flex flex-col justify-center items-center text-center">
              <FileCheck2 className="h-8 w-8 text-primary mb-2 animate-pulse" />
              <span className="text-xs font-medium text-foreground">Tectonic Compiler</span>
              <span className="text-[10px] text-foreground/50 mt-1">Status: Success (0.12s)</span>
            </LiquidGlassCard>
            <LiquidGlassCard className="border-border bg-white p-4 rounded-xl shadow-lg flex flex-col justify-between aspect-[4/3]">
      ...
      content: (
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <LiquidGlassCard className="flex-1 border-border bg-background p-4 flex items-center gap-3">
              <Download className="h-5 w-5 text-[#dd7e21]" />
              <div>
                <p className="text-xs font-semibold text-foreground">Download PDF</p>
                <p className="text-[10px] text-foreground/60">Ready for arXiv submission</p>
              </div>
            </LiquidGlassCard>
            <LiquidGlassCard className="flex-1 border-border bg-background p-4 flex items-center gap-3">
              <Share2 className="h-5 w-5 text-emerald-600" />
              <div>
                <p className="text-xs font-semibold text-foreground">Invite Collaborators</p>
                <p className="text-[10px] text-foreground/60">Configured with git worktrees</p>
              </div>
            </LiquidGlassCard>
          </div>
        </div>
